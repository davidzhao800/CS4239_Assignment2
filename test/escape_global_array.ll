; ModuleID = 'escape_global_array.c'
...
define void @escape_local2(i8** %argptr, i8* %aChar, i32 %aInt) #0 {
  ...
  %4 = getelementptr inbounds [10 x i8]* %array, i32 0, i32 0, !dbg !26
  store i8* %4, i8** @globalptr, align 8, !dbg !26
  %5 = getelementptr inbounds [10 x i8]* %array, i32 0, i32 0, !dbg !27
  %6 = load i8*** %1, align 8, !dbg !27
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/cs4239/Documents/CS4239_Assignment2/test/escape_global_array.c]
...
!28 = metadata !{i32 6, i32 0, metadata !4, null}
