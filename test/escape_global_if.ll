...
define void @escape_local2(i8** %argptr, i8* %aChar, i32 %aInt) #0 {
  ...
  %4 = load i32* %i, align 4, !dbg !25
  %5 = icmp ne i32 %4, 0, !dbg !25
  br i1 %5, label %6, label %7, !dbg !25

; <label>:6                                       ; preds = %0
  store i8* %local_char, i8** @globalptr, align 8, !dbg !27
  br label %9, !dbg !29

; <label>:7                                       ; preds = %0
  %8 = load i8*** %1, align 8, !dbg !30
  store i8* %local_char, i8** %8, align 8, !dbg !30
  br label %9
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/cs4239/Documents/CS4239_Assignment2/test/escape_global_if.c]
...
!26 = metadata !{i32 786443, metadata !1, metadata !4, i32 5, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/cs4239/Documents/CS4239_Assignment2/test/escape_global_if.c]
!27 = metadata !{i32 6, i32 0, metadata !28, null}
!28 = metadata !{i32 786443, metadata !1, metadata !26, i32 5, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/cs4239/Documents/CS4239_Assignment2/test/escape_global_if.c]
!29 = metadata !{i32 7, i32 0, metadata !28, null}
!30 = metadata !{i32 8, i32 0, metadata !31, null} ; [ DW_TAG_imported_declaration ]
!31 = metadata !{i32 786443, metadata !1, metadata !26, i32 7, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/cs4239/Documents/CS4239_Assignment2/test/escape_global_if.c]
